...
@section('title', 'Modulo Genericos')
                ...
                <div class="card" style="border-radius: 20px;">
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center mb-4">
                            <h4 class="card-title" style="font-size: 24px;">Lista de Genericos</h4>
                        </div>
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            ...
                            <div class="d-flex flex-column flex-md-row justify-content-between align-items-stretch gap-2">
                                <div class="input-group">
                                    <form action="{{ route('genericos.index') }}" method="GET" class="input-group">
                                ...
                                <button class="btnAgregarGenerico"
                                    ...
                                    data-bs-toggle="modal" data-bs-target="#nuevoGenerico">
                                    <i class="fas fa-plus"></i> Nuevo Generico
                                </button>
                            </div>
                        </div>
                                    ...
                                    @foreach ($genericos as $generico)
                                        <tr>
                                            ...
                                            <td class="font-weight-medium text-dark border-top-0 px-2 py-4">
                                                ...
                                                @else
                                                    <form action="{{ route('genericos.activar', $generico->id) }}"
                                                        method="POST" style="display:inline;"
                                                ...
                                                <div class="modal-content border-0 shadow"
                                                    ...
                                                    <div class="modal-header text-white py-3 px-4"
                                                        ...
                                                        <h5 class="modal-title fw-semibold mb-0"
                                                            id="editarGenericoLabel{{ $generico->id }}">
                                                    ...
                                                    <!-- Formulario -->
                                                    <form action="{{ route('genericos.actualizar', $generico->id) }}"
                                                            ...
                                                            <div class="row g-3">
                                                                ...
                                                                <div class="col-md-12">
                                                                    ...
                                                                    <input type="text" class="form-control rounded-3"
                                                                        id="nombre{{ $generico->id }}" name="nombre"
                                                                        value="{{ $generico->nombre }}" required>
                                                                    <div class="invalid-feedback"
                                                                        id="nombreError{{ $generico->id }}">
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content border-0" style="border-radius: 12px; background-color: #ffffff; overflow: hidden;">
                ...
                <div class="modal-header text-white" style="background-color: #0A7ABF;">
                    <h5 class="modal-title fw-bold" id="nuevoGenericoLabel">
                        <i class="bi bi-folder-plus me-2"></i>Registrar nuevo generico
                    </h5>
                ...
                <div class="modal-body px-4 py-4" style="background-color: #F9F9F9;">
                    <form action="{{ route('genericos.store') }}" method="POST" class="needs-validation" novalidate>
                        @csrf

                        <div class="row g-3">
                            <!-- Nombre de la categoría -->
                            <div class="col-md-12">
                                <label for="nombre" class="form-label text-dark">Nombre del generico</label>
                        ...
                        <div class="modal-footer mt-4 border-0 px-0 d-flex justify-content-end"
                            ...
                            <button type="submit" class="btn text-white rounded-3" style="background-color: #25A6D9;">
                                <i class="bi bi-save me-1"></i>Guardar generico
                            </button>
                        </div>
                    </form>
                </div>
...
@section('scripts')
    ...
    <script>
        function confirmarDesactivacion(id) {
            Swal.fire({
                title: '¿Estás seguro?',
                text: "El generico será marcado como inactivo",
                icon: 'warning',
        ...
        function confirmarActivacion(id) {
            Swal.fire({
                title: '¿Reingresar generico?',
                text: "El generico será marcado como activo nuevamente.",
                icon: 'question',
                showCancelButton: true,
