                        ...
                        <form id="formBusquedaCompras"
                            ...
                            <div class="input-group" style="min-width: 240px;">
                                <input type="text" name="buscar" id="inputBusqueda" class="form-control"
                                    placeholder="Buscar por código, proveedor, documento, usuario..."
                            ...
                            <div>
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownExportar">
                                        <li>
                                            <a class="dropdown-item" href="{{ route('compras.exportar', 'pdf') }}">
                                                <i class="fas fa-file-pdf text-danger me-2"></i> PDF
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item" href="{{ route('compras.exportar', 'xlsx') }}">
                                                <i class="fas fa-file-excel text-success me-2"></i> Excel
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item" href="{{ route('compras.exportar', 'csv') }}">
                                                <i class="fas fa-file-csv text-primary me-2"></i> CSV
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item" href="{{ route('compras.exportar', 'txt') }}">
