...
@section('title', 'Modulo Documentos')
...
@section('content')
                ...
                <div class="card" style="border-radius: 20px;">
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center mb-4">
                            <h4 class="card-title" style="font-size: 24px;">Lista de Documentos</h4>
                        </div>
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            ...
                            <div class="d-flex flex-column flex-md-row justify-content-between align-items-stretch gap-2">
                                <div class="input-group">
                                    <form action="{{ route('documentos.index') }}" method="GET" class="input-group">
                                ...
                                <button class="btnAgregarDocumento"
                                    ...
                                    data-bs-toggle="modal" data-bs-target="#nuevoDocumento">
                                        ...
                                        <tr>
                                            ...
                                            <td class="font-weight-medium text-dark border-top-0 px-2 py-4">
                                                ...
                                                @if ($documento->estado === 'Activo')
                                                    <form action="{{ route('documentos.desactivar', $documento->id) }}"
                                                        method="POST" style="display:inline;"
                                                        id="form-desactivar-{{ $documento->id }}">
                                                        @csrf
                                                        @method('PUT')
                                                ...
                                                @else
                                                    <form action="{{ route('documentos.activar', $documento->id) }}"
                                                        method="POST" style="display:inline;"
                                                ...
                                                <div class="modal-content" style="border-radius: 20px;">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title"
                                                            id="editarDocumentoLabel{{ $documento->id }}">
                                                            Editar Documento</h5>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                            aria-label="Cerrar"></button>
                                                    </div>
                                                    <form action="{{ route('documentos.actualizar', $documento->id) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('PUT')
                                                        <div class="modal-body">
                                                            <div class="form-group mb-3">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    id="nombre{{ $documento->id }}" name="nombre"
    ...
    <div class="modal fade" id="nuevoDocumento" tabindex="-1" aria-labelledby="nuevoDocumentoLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content shadow border-0 rounded-4 overflow-hidden">

            <!-- Encabezado -->
            <div class="modal-header bg-primary text-white py-3">
                <h5 class="modal-title fw-bold" id="nuevoDocumentoLabel">
                    <i class="bi bi-folder-plus me-2"></i> Nuevo Documento
                </h5>
            ...
            <div class="modal-body p-4">
                <form action="{{ route('documentos.store') }}" method="POST" class="needs-validation" novalidate>
                    ...
                    <div class="mb-3">
                        <label for="nombre" class="form-label fw-semibold">Nombre del documento</label>
                        <input type="text" class="form-control form-control-lg rounded-3" id="nombre" name="nombre" placeholder="Ej: Factura" required>
...
@section('scripts')
    ...
    <script>
        function confirmarDesactivacion(id) {
            Swal.fire({
                title: '¿Estás seguro?',
                text: "El documento será marcado como inactivo",
                icon: 'warning',
        ...
        function confirmarActivacion(id) {
            Swal.fire({
                title: '¿Reingresar documento?',
                text: "El documento será marcado como activo nuevamente.",
                icon: 'question',
                showCancelButton: true,
