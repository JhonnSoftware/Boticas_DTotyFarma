    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-7 align-self-center">
                <h3 class="page-title text-truncate text-dark font-weight-medium mb-1">Buenos dias {{ auth()->user()->name }}!</h3>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-6 col-md-12">
                <div class="card shadow-sm mb-4">
                    <div class="card-header text-white" style="background-color: #6c757d;">
                        <h5 class="mb-0"><i class="fas fa-list-ol me-2"></i> Top 5 Productos Más Vendidos</h5>
                    </div>
                    <div class="card-body">
                        <ul class="list-group list-group-flush">
                            @foreach ($productosMasVendidos as $detalle)
                                <li class="list-group-item d-flex align-items-center">
                                    <img src="{{ url($detalle->producto->foto ?? 'imagenes/producto_defecto.jpg') }}"
                                        alt="Imagen" class="rounded me-3" width="50" height="50"
                                        style="object-fit: cover; border: 1px solid #ccc;">
                                    <div class="flex-grow-1">
                                        <strong>{{ $loop->iteration }}.
                                            {{ $detalle->producto->descripcion ?? 'Producto eliminado' }}</strong>
                                        <br>
                                        <small class="text-muted">Código:
                                            {{ $detalle->producto->codigo ?? 'N/A' }}</small>
                                    </div>
                                    <span class="badge bg-primary rounded-pill">{{ $detalle->total_vendidos }} und</span>
                                </li>
                            @endforeach
                        </ul>
                    </div>
            ...
            <div class="col-lg-6 col-md-12">
                <div class="card shadow-sm mb-4">
                    <div class="card-header text-white" style="background-color: #dc3545;">
                        <h5 class="mb-0"><i class="fas fa-exclamation-circle me-2"></i> Top 5 Productos con Menor Stock
                        </h5>
                    </div>
                    <div class="card-body">
                        <ul class="list-group list-group-flush">
                            @foreach ($productosStockBajoTop as $producto)
                                <li class="list-group-item d-flex align-items-center">
                                    <img src="{{ url($producto->foto ?? 'imagenes/producto_defecto.jpg') }}"
                                        alt="Imagen" class="rounded me-3" width="50" height="50"
                                        style="object-fit: cover; border: 1px solid #ccc;">
                                    <div class="flex-grow-1">
                                        <strong>{{ $loop->iteration }}. {{ $producto->descripcion }}</strong><br>
                                        <small class="text-muted">Stock: {{ $producto->cantidad }} / Mínimo:
                                            {{ $producto->stock_minimo }}</small>
                                    </div>
